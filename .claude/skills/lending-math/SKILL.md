...
All weighted averages for cash flow projections use **Current loans with March 2019 last payment date only**.
...
- **CPR**: From Current loans with March 2019 last payment date ONLY (the population that enters projections)
...
8. **Applying CPR to cohort-level SMM** — The CPR provided to `compute_pool_assumptions()` should come from Current loans with March 2019 last payment only, not all current loans.
